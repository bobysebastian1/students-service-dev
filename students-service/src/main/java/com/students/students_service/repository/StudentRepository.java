...
public interface StudentRepository extends JpaRepository<StudentEntity, Long> {
    ...
    @Query(value = "SELECT * FROM STUDENTS WHERE LOWER(name) LIKE LOWER(CONCAT(:name, '%'))", nativeQuery = true)
    List<StudentEntity> findByNameLikeIgnoreCase(@Param("name") String name);
}
